...
{
	return [_problem isEqualToString:(NSString *)aProblem.problem];
}

- (BOOL)isEqualToString:(const NSString *) aProblem
{
	return [_problem isEqualToString:(NSString *)aProblem];
}
...
- (int)code {
	return (int)[[[self class] validProblems] indexOfObject:_problem];
}

- (NSString *)description
{
	return [NSString stringWithFormat:@"OAuth Problem: %@", (NSString *)_problem];
}
